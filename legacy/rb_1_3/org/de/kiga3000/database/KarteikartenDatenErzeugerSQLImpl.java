 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class KarteikartenDatenErzeugerSQLImpl{
//	implements KarteikartenDatenErzeuger {
		
//	private Connection conn;
	private PreparedStatement p;

//		public KarteikartenDatenErzeugerSQLImpl() throws PoolException, SQLException {
//				conn=Ressourcen.getConnection(5000);
//				conn.setAutoCommit(true);
//				p=conn.prepareStatement("INSERT INTO `Karteikarte` ( `gruppe`, `lastaccess`, `kindgeburt`, `eintritt`, `eintrittsgrund`, `austritt`, `austrittsgrund`, `kindnachname`, `kindvorname`, `geburtsort`, `kindwohnung`, `religion`, `staat`, `kindtelefon`, `vatername`, `vatergeburt`, `vaterberuf`, `muttername`, `muttergeburt`, `mutterberuf`, `sorgeperson`, `arbeitsort1`, `arbeittel1`, `arbeitsort2`, `arbeittel2`, `geschwgeburt`, `famstand`, `elternort`, `elterntel`, `anzahlgeschw`, `impfung`, `tetanuszeit`, `krankheiten`, `wkrankheit`, `gesundheit`, `arztort`, `arzttel`, `krankenkasse`, `sonstiges`) VALUES (?, CURDATE(), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
//			}

	/* (non-Javadoc)
	 * @see KarteikartenDatenErzeuger#insertKarteikarte(Karteikarte)
	 */
	public void insertKarteikarte(Karteikarte i,Connection conn)
