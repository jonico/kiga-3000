...
public class KigaMainControl {
    ...
    public void startApplication() {
		...
		String pfadLog = "";
		try {
			// filled from configuration object
			pfadLog = config.getConfig("KiGaLoggingPath");
			try {
				// try to get propertie file on given path
				InputStream inp = new FileInputStream(pfadLog
						+ "/org/de/kiga3000/properties/KiGaLogging.properties");
				InputStreamReader inpr = new InputStreamReader(inp, "UTF8");
				// read configuration
